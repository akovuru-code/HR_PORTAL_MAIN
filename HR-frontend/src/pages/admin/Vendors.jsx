...
export default function AdminVendors() {
    ...
    async function handleEdit(vendor) {
        ...
        if (!await requestOrUseAdminAction({ actionType: 'edit', resourceType: 'vendor', resourceId: vendor.id, resourceLabel: `vendor ${vendor.name}` })) return;
    ...
    async function handleDelete(vendor) {
        ...
        if (!await confirmOrRequestDelete({ resourceType: 'vendor', resourceId: vendor.id, resourceLabel: `vendor ${vendor.name}` })) return;
        try {

...
export default function Register() {
  return <label className="text-xl font-semibold">Admins can register employees from the Admin Panel. Employees can register themselves using the link sent to their email.</label>;
}


/* Temporarily disabled, Admins can register employees from the Admin Panel. Employees can register themselves using the link sent to their email.
...
export default function Register() {
  ...
  useEffect(() => {
    if (fillingCompany) {
      localStorage.setItem("fillingCompany", fillingCompany);
      sessionStorage.setItem("fillingCompany", fillingCompany);
    }
  }, [fillingCompany]);

...
export default function EmployeeProfile() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file && ["image/jpeg", "image/png", "image/jpg"].includes(file.type)) {
      ...
      reader.onload = (ev) => {
        setDraft((prev) => ({ ...prev, profileImage: ev.target.result }));
      };
  ...
  return (
    <div className="w-full max-w-16xl mx-auto py-12 px-8 md:px-10">
      <EmpTypography.h1 className="mb-6 px-4 md:px-0 text-3xl">Profile</EmpTypography.h1>
      <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col gap-8">
          ...
          <div className="flex-1 flex flex-col gap-2">
            <div className="flex gap-4">
              <div className="flex-1">
                <EmpTypography.label className="mb-1 block">First Name</EmpTypography.label>
                <input
                  type="text"
              ...
              <div className="flex-1">
                <EmpTypography.label className="mb-1 block">Last Name</EmpTypography.label>
                <input
                  type="text"
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                <EmpTypography.label className="mb-1 block">Role</EmpTypography.label>
                <input
                  type="text"
                  value={draft.jobRole}
              ...
              <div className="flex-1">
                <EmpTypography.label className="mb-1 block">Job Description</EmpTypography.label>
                <input
                  type="text"
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full">
          <div className="flex-1">
            <EmpTypography.label className="mb-1 block">Status</EmpTypography.label>
            <input
              type="text"
              value={draft.status}
        ...
        <div className="flex flex-col w-full">
          <EmpTypography.label className="mb-1 block">My Task Notes</EmpTypography.label>
          <textarea
            className="w-full min-h-[120px] border rounded-lg p-3 text-gray-800 bg-white resize-y"
            value={draft.notes}
        ...
        <div className="flex gap-2 mt-4 justify-end">
          {!editing ? (
            <EmpTypography.button variant="primary" onClick={handleEdit}>Edit</EmpTypography.button>
          ) : (
            <>
              <EmpTypography.button variant="primary" onClick={handleSave} disabled={saving}>
                {saving ? "Saving..." : "Save"}
              </EmpTypography.button>
              <EmpTypography.button variant="secondary" onClick={handleCancel} disabled={saving}>
                Cancel
              </EmpTypography.button>
            </>
          )}

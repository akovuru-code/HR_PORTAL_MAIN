        ...
        <div className="w-full min-h-screen bg-gray-50 py-10 px-0 md:px-8">
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-2xl shadow p-8 w-full">
                    {/* Page Header */}
                    <EmpTypography.h1 className="mb-2 text-3xl">Help & Support</EmpTypography.h1>
                    <div className="mb-8 text-gray-500 text-lg">We're here to assist you with anything.</div>
                    {/* Contact Info */}
                    <div className="mb-8">
                        <EmpTypography.h2 className="mb-4 text-xl font-semibold">Contact Information</EmpTypography.h2>
                        <div className="flex flex-col md:flex-row gap-8">
                            <div className="flex-1 flex flex-col gap-3">
                                ...
                                {/* <div className="flex items-center gap-2 text-gray-800"><span className="text-xl">💼</span><span className="font-semibold">US <Address></Address>:</span> Admin Support Lead</div> */}
                    ...
                    {/* Feedback Form */}
                    <div>
                        <EmpTypography.h2 className="mb-4 text-xl font-semibold">Feedback & Suggestions</EmpTypography.h2>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-end">
                                <EmpTypography.button type="submit" variant="primary">Submit Feedback</EmpTypography.button>
                            </div>
                        </form>
                    </div>
                </div>
